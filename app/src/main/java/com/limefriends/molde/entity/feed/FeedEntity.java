...
public class FeedEntity {
    ...
    public FeedEntity(String userName, String userEmail, String userId, String repContents, double repLat, double repLon, String repAddr, String repDetailAddr, String repDate, List<FeedImageResponseInfoEntity> repImg, int repState) {
    ...
    public FeedEntity(int repId, String userName, String userEmail, String userId, String repContents, double repLat, double repLon, String repAddr, String repDetailAddr, String repDate, List<FeedImageResponseInfoEntity> repImg, int repState) {
        this.repId = repId;
        this.userName = userName;
        this.userEmail = userEmail;
        this.userId = userId;
