...
public class MoldeMyPageMyCommentAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private List<MoldeCommentEntity> moldeCommentEntityList = new ArrayList<>();

    public MoldeMyPageMyCommentAdapter(Context context, int resourceId) {
        this.context = context;
        this.resourceId = resourceId;
       // this.moldeCommentEntityList = moldeCommentEntityList;
    }

    public void setData(List<MoldeCommentEntity> data) {
        this.moldeCommentEntityList = data;
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
        ...
        // feed summary
//        viewHorder.myComment_title.setText(moldeCommentEntityList.get(position).getMyComment_title());
//        Glide.with(context).load(moldeCommentEntityList.get(position).getMyComment_image())
//                .into(viewHorder.myComment_image);
        // comment
        viewHorder.myComment_comment.setText(moldeCommentEntityList.get(position).getComment());
        viewHorder.myComment_date.setText(moldeCommentEntityList.get(position).getCommDate());
    ...
    public int getItemCount() {
        return moldeCommentEntityList.size();
    }
}
