...
import com.limefriends.molde.entity.feed.MoldeFeedImageResponseInfoEntity;
...
public class FeedDetailActivity extends AppCompatActivity {
    ...
    public void loadReport(int reportId) {
        ...
        Call<MoldeFeedResponseInfoEntityList> call = feedService.getFeedById(reportId);
            ...
            public void onResponse(Call<MoldeFeedResponseInfoEntityList> call, Response<MoldeFeedResponseInfoEntityList> response) {
                if (response.isSuccessful()) {
                    ...
                    if (entityList != null && entityList.size() != 0) {
                        MoldeFeedEntity entity = fromSchemaToLocalEntity(response.body().getData()).get(0);
                        // 위치
                        ...
                        // 신고 이미지
                        List<MoldeFeedImageResponseInfoEntity> imageList = entity.getRepImg();
