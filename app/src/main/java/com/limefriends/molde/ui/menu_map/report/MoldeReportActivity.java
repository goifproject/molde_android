package com.limefriends.molde.ui.menu_map.report;
...
import com.limefriends.molde.ui.menu_map.camera_manager.MoldeReportCameraActivity;
import com.limefriends.molde.ui.menu_map.entity.MoldeReportEntity;
    ...
    protected void onResume() {
        ...
        send_report_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                } else if (report_email_self_input.getVisibility() == View.VISIBLE && report_email_self_input.getVisibility() == View.GONE) {
                ...
                if (RegexUtil.validateEmail(reportEmail)) {
                    ...
                    Call<Result> moldeReportEntityCall = feedService.reportNewFeed2(
                            reportUserId,
                            reportUserName,
                            0,
                            reportContent,
