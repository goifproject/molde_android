...
public class MyCardNewsCommentAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    // private List<CommentEntity> myPageMyCommentEntityList;
    ...
    public int getItemViewType(int position) {
        if (myCommentList.get(position) instanceof CardNewsEntity) {
            return CARD_NEWS;
        } else if (myCommentList.get(position) instanceof CommentEntity) {
            return COMMENT;
        }
        return -1;
    }
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
        ...
        if (holder instanceof CardNewsViewHolder) {
            final CardNewsEntity entity = (CardNewsEntity) myCommentList.get(position);
            ...
            final CommentEntity entity = (CommentEntity) myCommentList.get(position);
            ...
            holder.itemView.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent = new Intent(context, CardNewsCommentActivity.class);
                    intent.putExtra("cardNewsId", entity.getNewsId());
