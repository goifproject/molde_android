 ...
 */
public class MoldeMyPageMyCardNewsCommentAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public MoldeMyPageMyCardNewsCommentAdapter(Context context) {
