...
//
    public interface OnClickFeedItemListener {
        void callFeedData(MoldeFeedEntity feedEntity);
    }

    public MoldeFeedRecyclerAdapter(Context context, OnClickFeedItemListener onClickFeedItemListener) {
...
//        this.onLoadMoreListener = onLoadMoreListener;
    ...
    public void addAll(List<MoldeFeedEntity> newReportFeed) {
...
//        }
//
//        public void bindItem(MoldeFeedEntity entity) {
