...
public class MoldeMyPageMyCommentAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private List<MyPageMyCommentEntity> myPageMyCommentEntityList;

    public MoldeMyPageMyCommentAdapter(Context context, int resourceId, List<MyPageMyCommentEntity> myPageMyCommentEntityList) {
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
        ...
        viewHorder.myComment_title.setText(myPageMyCommentEntityList.get(position).getMyComment_title());
        Glide.with(context).load(myPageMyCommentEntityList.get(position).getMyComment_image())
                .into(viewHorder.myComment_image);
        viewHorder.myComment_date.setText(myPageMyCommentEntityList.get(position).getMyComment_date());
        viewHorder.myComment_comment.setText(myPageMyCommentEntityList.get(position).getMyComment_comment());
    ...
    public int getItemCount() {
        return myPageMyCommentEntityList.size();
    }
}
