...
public class MyPageMyCommentEntity {
    String myComment_title;
    int myComment_image;
    String myComment_date;
    String myComment_comment;

    public MyPageMyCommentEntity(String myComment_title, int myComment_image, String myComment_date, String myComment_comment) {
