...
public class MapViewImpl extends BaseObservableView<MapView.Listener> implements MapView {
    ...
    //private FrameLayout map_fragment_container;
    /**
     * 지도
     */
    ...
    private void setupViews() {
        ...
        mGoogleMapView = mViewFactory.newInstance(GoogleMapView.class, R.id.map_fragment_container);
    }
    ...
    private void showReportCardListDialog(int reportId) {
        ...
        reportCardListDialog.registerListener(feedId -> {
            for (Listener listener : getListeners()) {
                listener.onReportCardItemClicked(feedId);
            }
        });
