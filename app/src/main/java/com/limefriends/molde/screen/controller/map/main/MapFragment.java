package com.limefriends.molde.screen.controller.map.main;
...
import static com.limefriends.molde.screen.view.map.main.MapViewImpl.MARKER_MY_LOCATION;
import static com.limefriends.molde.screen.view.map.main.MapViewImpl.MARKER_MY_LOCATION_FAVORITE;
import static com.limefriends.molde.screen.view.map.main.MapViewImpl.MARKER_MY_LOCATION_PRE_FAVORITE;
import static com.limefriends.molde.screen.view.map.main.MapViewImpl.MARKER_SAFEHOUSE;
...
public class MapFragment extends BaseFragment implements
    ...
    @Override
    public void onReportCardItemClicked(int feedId) {
        mActivityScreenNavigator.toFeedDetailActivity(feedId);
    }
